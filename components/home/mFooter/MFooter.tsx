...
const MFooter: FC<IProps> = () => {
  ...
  return <div className={styles.footerBox}>
    <p className={styles.warnTxt}>请所有作者发布小说作品时务必遵守国家互联网信息管理办法，规定，我们拒绝任何色情小说，一经发现，即作删除！</p>
    <p>
      京公网安备 11010802023944号｜
      <Link className={styles.link} href={'https://beian.miit.gov.cn/'} target={'_blank'}>京ICP备16016315号-20</Link>
    </p>
