...
const PcBookTabs: FC<IProps> = ({ onChange, activeIndex, bookInfo, chapters }) => {
  const tabList = [
    { value: 'book_info', label: '书籍信息', child: <PcFirstChapter bookInfo={bookInfo}/>
    },
    { value: 'catalog_info', label: '目录', child: <PcCatalogBox chapters={chapters}/>  },
  ]
